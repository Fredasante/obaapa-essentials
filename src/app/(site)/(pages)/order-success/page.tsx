...
export default function OrderSuccessPage() {
  ...
  if (error || !orderDetails) {
    return (
      <>
        <section className="overflow-hidden mb-5 md:mb-10 lg:mb-15">
  ...
  return (
    <>
      <section className="overflow-hidden py-5 md:py-10 lg:py-12 bg-[#F7F8FA] mb-5 md:mb-10 lg:mb-15">
        <div className="max-w-[900px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          ...
          <div className="bg-white shadow-1 rounded-[10px] p-6 mt-2 sm:mt-0 sm:p-8 mb-7.5 text-center">
            ...
            <p className="text-sm text-gray-500 mt-3">
              Order ID:{" "}
              <span className="font-mono font-semibold text-seaBlue-dark">
                {orderId}
              </span>
            </p>
            {reference && (
          ...
          <div className="bg-white shadow-1 rounded-[10px] p-6 sm:p-8 mb-7.5">
            <h2 className="text-xl font-semibold text-dark mb-5 flex items-center gap-2">
              <Package className="w-5 h-5 text-seaBlue-dark" />
              Order Details
            </h2>
                  ...
                  <div className="flex-1">
                    ...
                    {(item.productSnapshot.size || item.productSnapshot.color) && (
                      <p className="text-xs text-gray-500">
                        {[
                          item.productSnapshot.size && `Size: ${item.productSnapshot.size}`,
                          item.productSnapshot.color && `Color: ${item.productSnapshot.color}`,
                        ].filter(Boolean).join(" · ")}
                      </p>
                    )}
          ...
          <div className="bg-white shadow-1 rounded-[10px] p-6 sm:p-8 mb-7.5">
            <h2 className="text-xl font-semibold text-dark mb-5 flex items-center gap-2">
              <Truck className="w-5 h-5 text-seaBlue-dark" />
              Delivery Information
            </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              onClick={handlePrint}
              className="flex-1 flex justify-center items-center gap-2 font-medium text-seaBlue-dark bg-white border border-seaBlue-dark py-3 px-6 rounded-md ease-out duration-200 hover:bg-gray-1 print:hidden"
            >
            ...
            <Link
              href="/shop"
              className="flex-1 flex justify-center items-center font-medium text-white bg-seaBlue-dark py-3 px-6 rounded-md ease-out duration-200 hover:bg-opacity-90 print:hidden"
            >
              Continue Shopping
            </Link>
          </div>
          ...
          {/* Support Section */}
          <div className="mt-7.5 lg:mt-9 text-center print:hidden">
            <p className="text-sm text-gray-600 mb-2">
              Need help with your order?
            </p>
            <a
              href="https://wa.me/233599287889"
              target="_blank"
