      ...
      <div className="py-8 px-4 sm:px-8.5">
        <div className="flex gap-4">
          <input
            ...
            className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-2.5 px-5 outline-none duration-200 focus:border-none disabled:opacity-50 disabled:cursor-not-allowed"
