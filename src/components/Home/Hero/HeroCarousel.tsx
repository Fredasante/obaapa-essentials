    ...
    <div className="flex items-center pt-6 sm:pt-0 flex-col-reverse sm:flex-row bg-[#f9f9f9]">
      ...
      <div className="max-w-[394px] py-10 pl-4 sm:pl-7.5 lg:pl-12.5 text-center sm:text-left">
        ...
        <h1 className="font-semibold text-dark text-2xl sm:text-4xl mb-3 leading-snug">
          Beautiful Décor. Unbeatable Prices. Your space deserves it!
        </h1>

        <p className="text-gray-700 leading-relaxed">
          Transform your space with our curated collection of home décor. From
          elegant vases to scented candles — enjoy{" "}
          <strong>30% off everything</strong> for a limited time only.
        </p>

        <Link
          href="/shop"
          className="inline-flex font-medium text-white text-custom-sm rounded-md bg-seaBlue-dark py-3 px-9 ease-out duration-200 hover:bg-seaBlue mt-10"
        >
          Shop Now
        </Link>
      </div>
