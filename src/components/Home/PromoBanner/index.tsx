  ...
  return (
    <section className="relative pt-5 lg:pt-0">
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 relative">
        <a
          href="#"
          className="inline-flex justify-between items-center py-1 px-1 pe-4 mb-7 text-sm text-seaBlue-dark bg-gray-1 shadow-md rounded-full"
        >
          <span className="text-xs bg-seaBlue-dark rounded-full text-white px-4 py-1.5 me-3">
            LIMITED
          </span>
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="bg-seaBlue-dark rounded-2xl p-6 shadow-2xl">
