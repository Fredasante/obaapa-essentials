...
const MyAccount = () => {
        ...
        <section className="overflow-hidden py-20 bg-[#F7F8FA] mb-5 md:mb-10 lg:mb-15">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex justify-center items-center min-h-[400px]">
              <ClipLoader size={26} color="#C85A1F" />
            </div>
          </div>
        </section>
      </>
  ...
  return (
    <>
      <section className="overflow-hidden py-5 sm:py-7 bg-[#F7F8FA] mb-5 md:mb-10 lg:mb-15">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
                ...
                <div className="flex items-center gap-4 p-5 border-b border-gray-3">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full overflow-hidden bg-blue-light-6 flex items-center justify-center flex-shrink-0">
                    {user.imageUrl ? (
                      ...
                      <span className="text-xl sm:text-2xl font-bold text-seaBlue-dark">
                  ...
                  <nav className="space-y-2">
                    <button
                      ...
                      className={`w-full flex items-center gap-3 rounded-lg py-3 px-4 text-sm font-medium transition-all duration-200 ${
                        activeTab === "dashboard"
                          ? "text-white bg-seaBlue-dark shadow-sm"
                      ...
                      <>
                        ...
                        {recentOrders.length > 0 && (
                          <div className="mt-8">
                            <div className="flex items-center justify-between mb-4">
                              ...
                              <button
                                onClick={() => setActiveTab("orders")}
                                className="text-xs sm:text-sm text-seaBlue-dark hover:text-opacity-95 font-medium transition-colors"
                              >
                                View All →
                              </button>
                            </div>
                        ...
                        <div className="mt-8 pt-6 border-t border-gray-3">
                          ...
                          <div className="flex flex-col sm:flex-row gap-3">
                            <button
                              onClick={() => setActiveTab("orders")}
                              className="flex items-center justify-center gap-2 font-medium text-white bg-seaBlue-dark py-3 px-6 rounded-lg transition-all duration-200 hover:bg-opacity-90 text-sm sm:text-base"
                            >
                            ...
                            <button
                              ...
                              className="flex items-center justify-center gap-2 font-medium text-seaBlue-dark bg-white py-3 px-6 rounded-lg transition-all duration-200 hover:bg-gray-1 border border-green-light-5 text-sm sm:text-base"
                            >
