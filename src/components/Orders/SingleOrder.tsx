  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:grid lg:grid-cols-12 gap-4 py-5 px-6 items-center hover:bg-gray-1 transition-colors">
        ...
        <div className="col-span-2">
          <button
            ...
            className="flex items-center gap-2 text-seaBlue-dark hover:text-opacity-95 transition-colors text-sm font-medium"
          >
      ...
      <div className="lg:hidden p-4">
        ...
        <button
          onClick={() => setShowDetails(!showDetails)}
          className="w-full flex items-center justify-center gap-2 text-seaBlue-dark hover:text-opacity-95 transition-colors text-sm font-medium py-2 border border-seaBlue-dark rounded-lg hover:bg-gray-1"
        >
          <Eye className="w-4 h-4" />
