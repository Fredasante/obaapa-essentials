      ...
      <div className="flex justify-center items-center min-h-[400px] px-4">
        <div className="max-w-md w-full bg-white shadow-lg rounded-xl p-8 text-center">
          <div className="w-16 h-16 bg-blue-light-6 rounded-full flex items-center justify-center mx-auto mb-4">
            <Package className="w-8 h-8 text-seaBlue-dark" />
          </div>
          ...
          <Link
            ...
            className="inline-block font-medium text-white bg-seaBlue py-3 px-8 rounded-lg ease-out duration-200 hover:bg-seaBlue-dark"
          >
      ...
      <div className="flex justify-center items-center min-h-[400px] px-4">
        <div className="max-w-md w-full bg-red-50 border border-red-200 rounded-xl p-8 text-center">
          ...
          <button
            ...
            className="inline-block font-medium text-white bg-seaBlue-dark py-2.5 px-6 rounded-lg ease-out duration-200 hover:bg-opacity-90"
          >
            Try Again
          </button>
        </div>
    ...
    return (
      <div className="flex justify-center items-center min-h-[400px] px-4">
        <div className="max-w-md w-full bg-white shadow-lg rounded-xl p-8 text-center">
          ...
          <Link
            href="/shop"
            className="inline-block font-medium text-white bg-seaBlue-dark py-3 px-8 rounded-lg ease-out duration-200 hover:bg-opacity-90"
          >
            Start Shopping
          </Link>
        </div>
