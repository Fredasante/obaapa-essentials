...
import { formatCategoryName } from "@/lib/productUtils";
...
export default function SearchPage() {
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (event: MouseEvent) => {
      ...
      // Close if clicking outside sidebar (but not on the toggle button)
      if (
        productSidebar &&
        sidebarRef.current &&
  ...
  const getPageTitle = () => {
    const categoryLabel = selectedCategory
      ...
      : "";
    if (searchQuery && selectedCategory) {
      return `Search Results for "${searchQuery}" in ${categoryLabel}`;
    } else if (searchQuery) {
  ...
  return (
    <>
      ...
      <section
        className="overflow-hidden relative pb-20 pt-5 lg:pt-12 bg-[#F7F8FA]"
        ref={productsTopRef}
      >
                ...
                <div className="flex flex-col gap-6">
                  <div className="bg-white shadow-1 rounded-lg py-4 px-5">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        type="button"
                        className="text-seaBlue-dark font-semibold"
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2.5">
                    <button
                      ...
                      className={`${
                        productStyle === "grid"
                          ? "bg-seaBlue-dark border-seaBlue-dark text-white"
                          : "text-dark bg-gray-1 border-gray-3"
                      } flex items-center justify-center w-10.5 h-9 rounded-[5px] border ease-out duration-200 hover:bg-seaBlue-dark hover:border-seaBlue-dark hover:text-white`}
                    >
                  ...
                  <div className="text-center col-span-full py-10">
                    <p className="text-lg font-semibold mb-2">
                      {searchQuery
                        ...
                        : `No products found in ${formatCategoryName(selectedCategory)}`}
                    </p>
