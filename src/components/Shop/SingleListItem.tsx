...
const SingleListItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group rounded-lg bg-white shadow-1">
      <div className="flex">
        <div className="shadow-list relative overflow-hidden max-w-[270px] w-full aspect-square sm:aspect-auto sm:min-h-[230px]">
          <Image
        ...
        <div className="w-full flex flex-col gap-5 sm:flex-row sm:items-center justify-center sm:justify-between py-5 px-4 sm:px-7.5 lg:pl-11 lg:pr-12">
          <div>
            <h3 className="font-medium text-dark ease-out duration-200 hover:text-seaBlue-dark mb-1.5 line-clamp-1">
            ...
            <div className="flex items-center gap-2.5">
              <button
                ...
                className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-seaBlue-dark"
              >
                <svg
